...
def show_dvds(root, container, id_usuario):
    ...
    b_lista.grid(row=0, column=2, padx=5)
    tk.Label(container, text="Libros en Renta:", bg=BG, fg=ROJO, font=(FUENTE, 16, "bold")).pack(pady=10)
    ...
    for libro in libros:
        ...
        tk.Label(card, text=libro["titulo"], bg=CARD, fg=TXT, font=(FUENTE, 12, "bold")).pack(anchor="w", pady=(5, 2))
        tk.Label(card, text="Categoria:", bg=CARD, fg=TXT, font=(FUENTE, 10, "bold")).pack(anchor="w")
        tk.Label(card, text=libro["categoria"], bg=CARD, fg=TXT).pack(anchor="w")
        tk.Label(card, text="Autor:", bg=CARD, fg=TXT, font=(FUENTE, 10, "bold")).pack(anchor="w")
        tk.Label(card, text=libro["autor"], bg=CARD, fg=TXT, wraplength=320, justify="left").pack(anchor="w")
